  ...
  return (
    ...
    >
      <div className="card-header">
        ...
        <div className="mt-3 p-3 bg-gradient-to-r from-blue-900/30 to-purple-900/30 border border-blue-500/30 rounded-lg">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-sm font-medium text-blue-300">🚀 Enhanced News Analysis - In Development</span>
          </div>
          <div className="mt-2 text-xs text-blue-200/80">
            <span className="text-green-400">✓ Current:</span> Real sentiment from market data •{' '}
            <span className="text-amber-400">💡 Coming Soon:</span> Live news feeds • AI agent insights • Company reports •{' '}
            <span className="text-purple-400">📅 Timeline:</span> Rolling out progressively
          </div>
        </div>

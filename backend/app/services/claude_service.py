...
Focus on interpreting the data rather than making investment recommendations.
            ...
            response = await self.generate_completion(
                prompt=prompt,
                system_prompt="You are an expert technical analyst providing educational commentary for a fintech dashboard. Be objective, educational, and clear in your explanations.",
                max_tokens=500,
                temperature=0.3
            )
